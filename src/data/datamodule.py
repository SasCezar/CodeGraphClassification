...
class GitRankingDataModule(LightningDataModule):
    ...
    def prepare_data(self):
        self._create_dataset(self.projects)
    ...
    def train_dataloader(self):
        return DataLoader(self.train_data, shuffle=True, batch_size=self.batch_size, num_workers=4)

    def val_dataloader(self):
        return DataLoader(self.val_data, shuffle=False, batch_size=self.batch_size, num_workers=4)

    def test_dataloader(self):
        return DataLoader(self.test_data, shuffle=False, batch_size=self.batch_size, num_workers=4)
    ...
    def _create_dataset(self, projects: DataFrame):
        data = GitRankingDataset(graph_dir=self.graph_dir, feature_dir=self.feature_dir,
                                 projects=projects, out_dir=self.root, num_classes=self.num_classes,
